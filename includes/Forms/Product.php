...
class Product implements Page {
    ...
    public function fire_hook():void{
        ...
        add_filter('woocommerce_sale_flash', array($this, 'modify_flash_sale_text'), 10, 3);
        add_filter('woocommerce_product_single_add_to_cart_text', array($this, 'modify_add_to_cart_button_text'));
        add_filter('woocommerce_get_stock_html', array($this, 'modify_availability_text'), 10, 2);
        // add_filter('the_content', array($this, 'modify_product_description'));
        add_filter('woocommerce_product_additional_information_heading', array($this, 'modify_additional_information_tab_title'));
        add_filter('woocommerce_product_reviews_tab_title', array($this, 'modify_reviews_tab_title'));
        add_filter('woocommerce_variation_select_options_html', array($this, 'modify_select_options_button_text'), 10, 2);
        add_filter('woocommerce_product_read_more_description', array($this, 'modify_read_more_button_text'));
        add_filter('woocommerce_product_out_of_stock_text', array($this, 'modify_out_of_stock_label'));
        add_filter('woocommerce_product_in_stock_text', array($this, 'modify_in_stock_label'));
        add_filter('woocommerce_get_availability', array($this, 'modify_availability_text_label'), 10, 2);
        add_filter('woocommerce_product_category_heading', array($this, 'modify_product_category_label'));
        add_filter('woocommerce_product_tag_heading', array($this, 'modify_product_tags_label'));
        add_filter('woocommerce_related_products_heading', array($this, 'modify_related_products_title'));
        add_filter('woocommerce_upsell_display_args', array($this, 'modify_upsells_title'));
        add_filter('woocommerce_cross_sells_display_args', array($this, 'modify_cross_sells_title'));
    }
    ...
    public function modify_product_description($content) {
        ...
        if (!empty($product_description)) {
            ...
            $content = wpautop(esc_html($product_description));
        }
    ...
    public function modify_select_options_button_text($html, $args) {
        $product_page_settings = get_option('wc_text_replace_product_page', array());
        ...
        if (!empty($select_options_button_text)) {
            ...
            $html = str_replace(__('Select options', 'woocommerce'), esc_html($select_options_button_text), $html);
        }
